...
/* SmartAlarmClock: outside Arduino the tables are ordinary const data. */
#ifndef PROGMEM
#define PROGMEM
#endif

/* SmartAlarmClock: the portable branch below is written with GCC's __inline__. */
...
*/
#if (defined (_WIN32) && !defined (_WIN32_WCE) && !defined (_WIN64)) /* SmartAlarmClock: inline asm is 32-bit only */ || (defined (__WINS__) && defined (_SYMBIAN)) || (defined (WINCE_EMULATOR)) || (defined (_OPENWAVE_SIMULATOR))
...
#elif defined(ARDUINO) || defined(_WIN64) || defined(__riscv) /* SmartAlarmClock: x64 MSVC, ESP32-P4 */ || defined(__GNUC__) && (defined(__mips__) || defined(__MIPS__)) || defined(__GNUC__) && (defined(__powerpc__) || defined(__POWERPC__)) || (defined (_SOLARIS) && !defined (__GNUC__) && !defined (_SOLARISX86))
